...
export const {
  ...
  useCategoryQuery, // get single department hooks
  useUpdateCategoryMutation, // update single department hooks
  useDeleteCategoryMutation, // delete single department hooks
} = categoryApi;
